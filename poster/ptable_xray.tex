...
%% add some extra space around table
  ...
  \node at ($(H.north  -|  H.west) - (2em, -2em)$)  [name=Space2, Space]{ };
   ...
   \node at ($(Th.south -| Fr.west) + (10mm, 35mm)$) [name=diagramTitle, SubTitleLabel]{};
    % {\small{\textsf{
    %       \begin{tabular*}{5mm}{l}
    %         This Periodic Table is available from: \\%
    %         {\hspace{5mm} http://cars.uchicago.edu/xray\_table/  \hfil} \\%
    %       \end{tabular*}
    %   }}};
