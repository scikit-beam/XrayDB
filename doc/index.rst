...
X-ray DB provides ``xraydb.sqlite``, an SQLite3 database of
atomic data, characteristic X-ray energies and X-ray cross sections for
the elements.  The project began with the data from the compilation of
Elam, Ravel, and Sieber.  More data has since been added.
